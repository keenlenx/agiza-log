...
<div class="moving-form form-control">
    ...
    <?= $form->field($model, 'Floor_no')->textInput(['maxlength' => true, 'id' => 'Floor_no', 'placeholder' => '1,2,3,4....']) ?>

    <?= $form->field($model, 'Move_description')->textarea(['rows' => 6, 'placeholder' => 'Describe the move']) ?>
