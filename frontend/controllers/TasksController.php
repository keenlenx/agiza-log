...
class TasksController extends Controller
{
    ...
    public function actionTasks()
    {
        ...
        // Search only by customer_email (apply the filter)
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        // Apply the filter for the logged-in user's ID that is assigned at partner ID
        $dataProvider->query->andWhere(['id' => $id]);

        // Render the tasks view with the filtered data provider
    ...
    public function actionOrders()
    {
        ...
        // Apply the filter for the logged-in user's ID that is assigned at partner ID
        $dataProvider->query->andWhere(['Customer_email' => $email]);
